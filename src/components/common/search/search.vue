...
<template>
  <div class="search-res">
    ...
    <!-- <div>
      <form action="/search" method="GET">
        <div>
          <input type="search" name="demo" style="border: 1px solid #ccc" :placeholder="$route.query.demo">
        </div>
      </form>
    </div> -->
    <div class="search-ct">
        ...
        <li v-if='dataShow' class='search-module'>
          ...
          <ul>
            <li v-for='(item,i) in subjects'><a href="">
              ...
              <div class="subject-info"><span><a :href="item.alt" title="">{{item.title}}</a></span>
                <p>
