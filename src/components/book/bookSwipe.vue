...
<template id="bookSwipe">
  ...
  <section class="section-content clearfix">
    <header>
      <!--接收一个标题-->
      <h2 style="display: block;width:100%;">豆瓣纸书<span class="fr cl" style="float: right;">更多</span></h2>
      ...
      <mt-swipe :auto="4000" :show-indicators="false">
        <mt-swipe-item :class="{slide1:true}">
          <a class="swipe-a" href="#">
            <img class="cover" src="../../assets/1384.jpg"
                 alt="">
            <div class="content">
              <div>
              ...
              <p class="content_summary">{{data.data.summary}}</p>
            </div>
          </a>
        </mt-swipe-item>
        <mt-swipe-item :class="{slide2:true}"><a class="swipe-a" href="#">
          <img class="cover" src="../../assets/1324.jpg"
               alt="">
          <div class="content">
            <div>
        ...
        <mt-swipe-item :class="{slide3:true}"><a class="swipe-a" href="#">
          <img class="cover" src="../../assets/898.jpg"
               alt="">
          <div class="content">
            <div>
