      ...
      <section class="subject-info clearfix">
        ...
        <div class="conentL">
          ...
          <p>
            ...
            <!--判断时候是最后一个人名 是就去掉/--><!--演员-->
            <span v-for='(item,i) in data.casts'>
            <!-- item.id 在跳过去的页面里面可以通过 this.$route.params.id 获取到 -->
              <router-link :to="'/movie/performer/'+item.id" style="margin-bottom:0;display: inline-block;">
                 {{item.name}} {{i+1 == data.casts.length ? " ":" / "}}
              </router-link> 
            </span> 
...
<style rel="stylesheet/less" lang="stylus">
